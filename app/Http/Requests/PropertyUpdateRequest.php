...
class PropertyUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'deed_pdf' => ['nullable', 'file', 'mimes:pdf', 'max:10240'],
    ...
    public function messages(): array
    {
        return [
            ...
            'deed_pdf.file' => 'El campo Escritura (PDF) debe ser un archivo',
            'deed_pdf.mimes' => 'El campo Escritura (PDF) debe ser un archivo PDF',
            'deed_pdf.max' => 'El campo Escritura (PDF) no puede pesar más de 10MB',
